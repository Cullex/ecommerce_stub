    ...
    export default {
        ...
        methods: {
            ...
            async updateProduct() {
                ...
                try {
                    await window.axios.post(`/products/update_product/${this.$route.params.id}`, formData, {
                        headers: {
                            "Content-Type": "multipart/form-data",
                        },
                    });
                    this.$router.push('/'); // Redirect after success
                    window.Swal.fire('Updated', 'Product Successfully Updated', 'success');
                } catch (error) {
                    this.loading = false;
    ...
    <div class="container mt-5">
        ...
        <form @submit.prevent="updateProduct" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <button :class="['btn btn-primary px-4', loading ? 'btn-loading' : '']" type="submit">Update Product</button>
            </div>
